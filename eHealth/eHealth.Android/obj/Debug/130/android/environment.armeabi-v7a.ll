...
@__app_environment_variables_v_2.5 = internal constant [37 x i8] c"1d76af9a-3c5e-406b-83de-aa6564f0fd2d\00", align 1
...
@__DSOCacheEntry_name.5 = internal constant [18 x i8] c"libonnxruntime.so\00", align 1
@__DSOCacheEntry_name.6 = internal constant [24 x i8] c"libonnxruntime4j_jni.so\00", align 1
@__DSOCacheEntry_name.7 = internal constant [16 x i8] c"libSkiaSharp.so\00", align 1
@__DSOCacheEntry_name.8 = internal constant [23 x i8] c"libmono-btls-shared.so\00", align 1
@__DSOCacheEntry_name.9 = internal constant [18 x i8] c"libmono-native.so\00", align 1
@__DSOCacheEntry_name.10 = internal constant [16 x i8] c"libe_sqlite3.so\00", align 1
@__DSOCacheEntry_name.11 = internal constant [19 x i8] c"libmonosgen-2.0.so\00", align 1
...
@dso_cache = local_unnamed_addr global [44 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; ignore
		i8* getelementptr inbounds ([24 x i8], [24 x i8]* @__DSOCacheEntry_name.6, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 6
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; ignore
		i8* getelementptr inbounds ([18 x i8], [18 x i8]* @__DSOCacheEntry_name.9, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 12
	%struct.DSOCacheEntry {
