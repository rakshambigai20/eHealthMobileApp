...
@__app_environment_variables_v_2.5 = internal constant [37 x i8] c"1d76af9a-3c5e-406b-83de-aa6564f0fd2d\00", align 16
...
@__ApplicationConfig_android_package_name.0 = internal constant [24 x i8] c"com.companyname.ehealth\00", align 16
...
@application_config = local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 193, ; number_of_assemblies_in_apk
	i32 70, ; bundled_assembly_name_width
	i32 2, ; number_of_assembly_store_files
	i32 44, ; number_of_dso_cache_entries
...
@__DSOCacheEntry_name.1 = internal constant [24 x i8] c"libonnxruntime4j_jni.so\00", align 16
@__DSOCacheEntry_name.2 = internal constant [18 x i8] c"libmono-native.so\00", align 16
@__DSOCacheEntry_name.3 = internal constant [24 x i8] c"libmono-profiler-log.so\00", align 16
@__DSOCacheEntry_name.4 = internal constant [18 x i8] c"libonnxruntime.so\00", align 16
@__DSOCacheEntry_name.5 = internal constant [16 x i8] c"libSkiaSharp.so\00", align 16
@__DSOCacheEntry_name.6 = internal constant [31 x i8] c"libxamarin-debug-app-helper.so\00", align 16
@__DSOCacheEntry_name.7 = internal constant [16 x i8] c"libe_sqlite3.so\00", align 16
@__DSOCacheEntry_name.8 = internal constant [23 x i8] c"libmono-btls-shared.so\00", align 16
@__DSOCacheEntry_name.9 = internal constant [16 x i8] c"libmonodroid.so\00", align 16
@__DSOCacheEntry_name.10 = internal constant [22 x i8] c"libxa-internal-api.so\00", align 16
@__DSOCacheEntry_name.11 = internal constant [19 x i8] c"libmonosgen-2.0.so\00", align 16

; dso_cache
@dso_cache = local_unnamed_addr global [44 x %struct.DSOCacheEntry] [
	; 0
	%struct.DSOCacheEntry {
		i64 1697759178405342290, ; hash 0x178fa6fa47026c52, from name: libonnxruntime4j_jni.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([24 x i8], [24 x i8]* @__DSOCacheEntry_name.1, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 1
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; ignore
		i8* getelementptr inbounds ([22 x i8], [22 x i8]* @__DSOCacheEntry_name.10, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 17
	%struct.DSOCacheEntry {
		...
		i8 0, ; ignore
		i8* getelementptr inbounds ([19 x i8], [19 x i8]* @__DSOCacheEntry_name.11, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 18
	%struct.DSOCacheEntry {
...
@bundled_assemblies = local_unnamed_addr global [193 x %struct.XamarinAndroidBundledAssembly] [
	; 0
